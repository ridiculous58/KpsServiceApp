...
namespace Infrastructure.Utilities.Security.Jwt
{
    public class JwtHelper : ITokenHelper
    {
        ...
        public JwtHelper(IConfiguration configuration)
        {
            ...
            _tokenOptions = Configuration.GetSection(JwtConfigurationHelper.TokenSection).Get<TokenOptions>(); // Microsoft.Extensions.Configuration.Binder package required
